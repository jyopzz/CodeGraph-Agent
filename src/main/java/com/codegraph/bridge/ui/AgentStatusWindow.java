...
public class AgentStatusWindow {
    ...
    private JPanel createContent() {
        ...
        agentStatusLabel =
                createValueLabel("● Running");

        versionLabel =
                createValueLabel("1.0.0");

        portLabel =
                createValueLabel("9870");
    ...
    private void refreshStatus() {
        ...
        try {
            ...
            CliProcessService.CodeGraphInfo info =
                    cliProcessService.detectInstallation();
